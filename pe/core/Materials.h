 ...
 */
inline Iron::Iron()
   : Material( "iron", static_cast<real>( 7874 ), static_cast<real>( 0.5 ), static_cast<real>( 0.1 ), static_cast<real>( 0.1 ), static_cast<real>( 0.24 ), static_cast<real>( 200 ), static_cast<real>( 200 ), static_cast<real>( 0 ), static_cast<real>( 0 ) )  // Initialization of the Material base class
{
...
inline Copper::Copper()
   : Material( "copper", static_cast<real>( 8920 ), static_cast<real>( 0.5 ), static_cast<real>( 0.1 ), static_cast<real>( 0.1 ), static_cast<real>( 0.33 ), static_cast<real>( 117 ), static_cast<real>( 117 ), static_cast<real>( 0 ), static_cast<real>( 0 ) )  // Initialization of the Material base class
{
...
inline Granite::Granite()
   : Material( "granite", static_cast<real>( 2800 ), static_cast<real>( 0.5 ), static_cast<real>( 0.1 ), static_cast<real>( 0.1 ), static_cast<real>( 0.25 ), static_cast<real>( 55 ), static_cast<real>( 55 ), static_cast<real>( 0 ), static_cast<real>( 0 ) )  // Initialization of the Material base class
{
 ...
 */
inline Oak::Oak()
   : Material( "oak", static_cast<real>( 800 ), static_cast<real>( 0.5 ), static_cast<real>( 0.1 ), static_cast<real>( 0.1 ), static_cast<real>( 0.35 ), static_cast<real>( 11 ), static_cast<real>( 11 ), static_cast<real>( 0 ), static_cast<real>( 0 ) )  // Initialization of the Material base class
{
 ...
 */
inline Fir::Fir()
   : Material( "fir", static_cast<real>( 500 ), static_cast<real>( 0.5 ), static_cast<real>( 0.1 ), static_cast<real>( 0.1 ), static_cast<real>( 0.34 ), static_cast<real>( 13 ), static_cast<real>( 13 ), static_cast<real>( 0 ), static_cast<real>( 0 ) )  // Initialization of the Material base class
{
